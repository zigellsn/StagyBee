...
urlpatterns = [
    ...
    path("workbook/help/", WorkbookHelpView.as_view(), name="workbook_help"),
    path("workbook/today/", WorkbookView.as_view(), name="workbook_today"),
    path("workbook/<date:date_from>/", WorkbookView.as_view(), name="workbook"),
    path("workbook/<date:date_from>/<date:date_to>/", WorkbookView.as_view(), name="workbook"),
